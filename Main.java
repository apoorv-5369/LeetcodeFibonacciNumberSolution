class Solution {
    public int fib(int n) {
        ...
        for(int i=2; i<n+1;i++){
            hm.put(i, hm.getOrDefault(i-1, 0)+hm.getOrDefault(i-2, 0)); //Putting values for ith fibonacci number by adding the previous two fibonacci numbers, which are already present in the HashMap.
        }
